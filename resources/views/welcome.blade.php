                        ...
                        <div id="owl-slider" class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <div class="slider-post post-height-1">
                                    <a href="#" class="news-image"><img src="../assets/images/slider-520x460-1.jpg" alt="" class="img-responsive"></a>
                                    <div class="post-text">
                            ...
                            <div class="item">
                                <div class="slider-post post-height-1">
                                    <a href="#" class="news-image"><img src="../assets/images/slider-520x460-2.jpg" alt="" class="img-responsive"></a>
                                    <div class="post-text">
                            ...
                            <div class="item">
                                <div class="slider-post post-height-1">
                                    <a href="#" class="news-image"><img src="../assets/images/slider-520x460-3.jpg" alt="" class="img-responsive"></a>
                                    <div class="post-text">
                            ...
                            <div class="item">
                                <div class="slider-post post-height-1">
                                    <a href="#" class="news-image"><img src="../assets/images/slider-520x460-4.jpg" alt="" class="img-responsive"></a>
                                    <div class="post-text">
                            ...
                            <div class="item">
                                <div class="slider-post post-height-1">
                                    <a href="#" class="news-image"><img src="../assets/images/slider-520x460-5.jpg" alt="" class="img-responsive"></a>
                                    <div class="post-text">
                                        <span class="post-category">Business</span>
                    ...
                    <div class="row slider-right-post thm-margin">
                        <div class="col-xs-6 col-sm-12 col-md-12 thm-padding hidden-xs">
                            <div class="slider-post post-height-2">
                                <a href="#" class="news-image"><img src="../assets/images/slider-520x230-6.jpg" alt="" class="img-responsive"></a>
                                <div class="post-text">
                                    <span class="post-category">Travel</span>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 thm-padding">
                            <div class="slider-post post-height-2">
                                <a href="#" class="news-image"><img src="../assets/images/slider-260x230-7.jpg" alt="" class="img-responsive"></a>
                                <div class="post-text">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 thm-padding">
                            <div class="slider-post post-height-2">
                                <a href="#" class="news-image"><img src="../assets/images/slider-260x230-8.jpg" alt="" class="img-responsive"></a>
                                <div class="post-text">
                                ...
                                <div class="item">
                                    <div class="row">
                                        <div class="col-sm-6 main-post-inner bord-right">
                                            <article>
                                                <figure>
                                                    <a href="#"><img src="../assets/images/340x215-1.jpg" height="242" width="345" alt="" class="img-responsive"></a>
                                                    <span class="post-category">Business</span>
                                                </figure>
                                                <div class="post-info">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="news-list">
                                                ...
                                                <div class="news-list-item">
                                                    <div class="img-wrapper">
                                                        <a href="#" class="thumb">
                                                            <img src="../assets/images/115x85-3.jpg" alt="" class="img-responsive">
                                                            <div class="link-icon">
                                                                <i class="fa fa-camera"></i>
                                                            </div>
                                                        </a>
                                                ...
                                                <div class="news-list-item">
                                                    <div class="img-wrapper">
                                                        <a href="#" class="thumb">
                                                            <img src="../assets/images/115x85-4.jpg" alt="" class="img-responsive">
                                                            <div class="link-icon">
                                                                <i class="fa fa-play"></i>
                                                            </div>
                                                        </a>
                                ...
                                <div class="item">
                                    <div class="row">
                                        <div class="col-sm-6 main-post-inner bord-right">
                                            <article>
                                                <figure>
                                                    <a href="#"><img src="../assets/images/340x215-2.jpg" height="242" width="345" alt="" class="img-responsive"></a>
                                                    <span class="post-category">Business</span>
                                                </figure>
                                                <div class="post-info">
                                                    <h3><a href="#">Fusce ac orci sagittis mattis magna ultrices libero</a></h3>
                                ...
                                <div class="item">
                                    <div class="row">
                                        <div class="col-sm-6 main-post-inner bord-right">
                                            <article>
                                                <figure>
                                                    <a href="#"><img src="../assets/images/340x215-3.jpg" height="242" width="345" alt="" class="img-responsive"></a>
                                                    <span class="post-category">Travel</span>
                                                </figure>
                                                <div class="post-info">
                                                    <h3><a href="#">Fusce ac orci sagittis mattis magna ultrices libero</a></h3>
                                                ...
                                                <div class="row row-margin">
                                                    <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                        <div class="grid-item">
                                                            <div class="grid-item-img">
                                                                <a href="#">
                                                                    <img src="../assets/images/165x110-1.jpg" class="img-responsive" alt="">
                                                    ...
                                                    <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                        <div class="grid-item">
                                                            <div class="grid-item-img">
                                                                <a href="#">
                                                                    <img src="../assets/images/165x110-2.jpg" class="img-responsive" alt="">
                                                    ...
                                                    <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                        <div class="grid-item">
                                                            <div class="grid-item-img">
                                                                <a href="#">
                                                                    <img src="../assets/images/165x110-3.jpg" class="img-responsive" alt="">
                                                                    <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                </a>
                                                            </div>
                                                    ...
                                                    <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                        <div class="grid-item">
                                                            <div class="grid-item-img">
                                                                <a href="#">
                                                                    <img src="../assets/images/165x110-4.jpg" class="img-responsive" alt="">
                                                                    <div class="link-icon"><i class="fa fa-play"></i></div>
                                                                </a>
                                                            </div>
                                ...
                                <div class="item">
                                    <div class="row">
                                        <div class="col-sm-6 main-post-inner bord-right">
                                            <article>
                                                <figure>
                                                    <a href="#"><img src="../assets/images/340x215-4.jpg" height="242" width="345" alt="" class="img-responsive"></a>
                                                    <span class="post-category">Travel</span>
                                                </figure>
                                                <div class="post-info">
                                                    <h3><a href="#">Fusce ac orci sagittis mattis magna ultrices libero</a></h3>
                                                ...
                                                <div class="row row-margin">
                                                    <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                        <div class="grid-item">
                                                            <div class="grid-item-img">
                                                                <a href="#">
                                                                    <img src="../assets/images/165x110-5.jpg" class="img-responsive" alt="">
                                                                    <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                </a>
                                                            </div>
                                                            <h5><a href="#" class="title">Lorem Ipsum is simply dummy text of the printing.</a></h5>
                                                    ...
                                                    <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                        <div class="grid-item">
                                                            <div class="grid-item-img">
                                                                <a href="#">
                                                                    <img src="../assets/images/165x110-6.jpg" class="img-responsive" alt="">
                                                                    <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                </a>
                                                            </div>
                                                            <h5><a href="#" class="title">It is a long established fact that a reader will be distracted by</a></h5>
                                                    ...
                                                    <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                        <div class="grid-item">
                                                            <div class="grid-item-img">
                                                                <a href="#">
                                                                    <img src="../assets/images/165x110-7.jpg" class="img-responsive" alt="">
                                                                    <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                </a>
                                                            </div>
                                                            <h5><a href="#" class="title">There are many variations of passages of Lorem Ipsum.</a></h5>
                                                    ...
                                                    <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                        <div class="grid-item">
                                                            <div class="grid-item-img">
                                                                <a href="#">
                                                                    <img src="../assets/images/165x110-8.jpg" class="img-responsive" alt="">
                                                                    <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                </a>
                                                            </div>
                                                            <h5><a href="#" class="title">Contrary to popular belief, Lorem Ipsum is not simply random text.</a></h5>
                ...
                <div class="theiaStickySidebar">
                    ...
                    <div class="panel_inner review-inner">
                        ...
                        <div class="panel_body">
                            <div class="more-post">
                                <a href="#" class="news-image"><img src="../assets/images/340x215-5.jpg" alt="" class="img-responsive"></a>
                                <div class="reatting">
                            ...
                            <div class="news-list">
                                <div class="news-list-item">
                                    <div class="img-wrapper">
                                        <a href="#" class="thumb">
                                            <img src="../assets/images/115x85-5.jpg" alt="" class="img-responsive">
                                            <div class="link-icon">
                                                <i class="fa fa-camera"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="news-list-item">
                                    <div class="img-wrapper">
                                        <a href="#" class="thumb">
                                            <img src="../assets/images/115x85-6.jpg" alt="" class="img-responsive">
                                            <div class="link-icon">
                                                <i class="fa fa-play"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="news-list-item">
                                    <div class="img-wrapper">
                                        <a href="#" class="thumb">
                                            <img src="../assets/images/115x85-7.jpg" alt="" class="img-responsive">
                                            <div class="link-icon">
                                                <i class="fa fa-camera"></i>
                                            </div>
                                        </a>
                                        ...
                                        <div class="posts__footer card__footer">
                                            <div class="post-author">
                                                <figure class="post-author-avatar hidden-xs">
                                                    <img src="../assets/images/avatar-1.jpg" alt="Post Author Avatar">
                                                </figure>
