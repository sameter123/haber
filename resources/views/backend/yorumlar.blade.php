                ...
                <section id="basic-datatable">
                    ...
                    <div class="table-responsive">
                        <table class="table zero-configuration1">
                            ...
                            <tbody>
                            @foreach(DB::table('yorumlar')->get() as $u)
                                <tr>
                                    <td>{{$u->title}}</td>
                                    <td>{{$u->title_2}}</td>
                                    <td>{{$u->uye}}</td>
                                    ...
                                    <td class="product-action">
                                        @if(Auth::user()->izin==2)
                                            <button data-toggle="tooltip" title="{{$u->title}} kategorisini düzenle"
                                                    ...
                                                    class="btn btn-icon btn-outline-info mr-1 mb-1 waves-effect waves-light">
                                        ...
                                        @endif
                                        @if(Auth::user()->izin==1)
                                            <button data-toggle="tooltip" title="Onayla"
                                                    onclick="location.href='?id={{$u->id}}&sil&token={{ csrf_token() }}'"
                                                    type="button"
                                                    class="btn btn-icon bg-gradient-success mr-1 mb-1 waves-effect waves-light">
