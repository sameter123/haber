    ...
    <div class="row">
            ...
            <div class="col-xl-6 col-12">
                <div class="card pull-up border-left-info border-left-2">
                    <div class="card-content">
                        <div class="card-body" onclick="location.href='/haberler'" style="cursor: pointer">
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                    <h3 class="info">{{DB::table('blog')->count()}}</h3>
                                    <h6>Haberler</h6>
                                </div>
                                <div>
            ...
            <div class="col-xl-6 col-12">
                <div class="card pull-up border-left-warning border-left-2">
                    <div class="card-content">
                        <div class="card-body" onclick="location.href='/haber-ekle'" style="cursor: pointer">
                            <div class="media d-flex">
                                <div class="media-body text-left">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert bg-success alert-icon-left alert-arrow-left alert-dismissible mb-2"
                                        ...
                                        <strong>Haber başarıyla silindi.</strong>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="alert bg-pink alert-icon-left alert-arrow-left alert-dismissible mb-2"
                                            ...
                                            <strong>Haber silme işlemi için güvenlik doğrulaması başarısız oldu.</strong>
                                        </div>
                                    </div>
                                </div>
                        ...
                        >
                            ...
                            @foreach(DB::table('blog')->get() as $u)
                                <tr>
                                    ...
                                    <td>
                                        <a href="?haber={{$u->id}}&sil&token={{ csrf_token() }}" class="btn btn-outline-danger btn-min-width">
                                            <i class="la la-trash"></i>
                                            <span>
                                                Sil
                                            </span>
                                        </a>
                                        <a href="/haber-duzenle/{{$u->id}}" class="btn btn-outline-info btn-min-width">
