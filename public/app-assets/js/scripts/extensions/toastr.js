...
$(document).ready(function(){
	...
	// sms mesaj
	$('#sms-mesaj').on('click',function(){
		toastr.error('Sms Servisi devre dışıdır. Satın almak için lütfen çözüm ortağınız ile iletişime geçin.', 
			'Sms Servisi', 
			{
				"progressBar": true,
	...
	// ön muhasebe
	$('#onmuhasebe-mesaj').on('click',function(){
		toastr.error('Ön Muhasebe devre dışıdır. Satın almak için lütfen çözüm ortağınız ile iletişime geçin.', 
			'Ön Muhasebe', 
			{
				"progressBar": true,
				positionClass: 'toast-bottom-left', 
	...
	// sosyal medya botu
	$('#sosyalmedyabotu-mesaj').on('click',function(){
		toastr.error('Sosyal Medya botu devre dışıdır. Satın almak için lütfen çözüm ortağınız ile iletişime geçin.', 
			'Sosyal Medya Botu', 
			{
				"progressBar": true,
				positionClass: 'toast-bottom-left', 
	...
	//form gönderim tamam
	$('#formOk').on('click',function(){
		toastr.info('Hata bildiriminiz teknik destek ekibine iletilmiştir. En kısa sürede konuyla alakalı dönüş yapılacaktır.', 
			'Teknik Destek', 
			{
				"progressBar": true,
	...
	//form gönderim tamam
	$('#formNotOk').on('click',function(){
		toastr.error('Hata bildiriminiz teknik destek ekibine iletilirken bir sorunla karşılaşıldı. Teknik ekibimiz bu durumdan haberdar edildi.', 
			'Teknik Destek', 
			{
				"progressBar": true,
				positionClass: 'toast-top-right', 
