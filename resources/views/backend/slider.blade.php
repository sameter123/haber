...
<?php
if(isset($_GET['slider']) AND isset($_GET['sil']) AND isset($_GET['token'])) {
    $id = $_GET['slider'];
    $token = $_GET['token'];
    ...
    <div class="row">
            ...
            <div class="col-xl-6 col-12">
                <div class="card pull-up border-left-info border-left-2">
                    <div class="card-content">
                        <div class="card-body" onclick="location.href='/slider'" style="cursor: pointer">
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                    <h3 class="info">{{DB::table('slider')->count()}}</h3>
                                    <h6>Slider</h6>
                                </div>
                                <div>
            ...
            <div class="col-xl-6 col-12">
                <div class="card pull-up border-left-warning border-left-2">
                    <div class="card-content">
                        <div class="card-body" onclick="location.href='/slider-ekle'" style="cursor: pointer">
                            <div class="media d-flex">
                                <div class="media-body text-left">
                        ...
                        >
                            ...
                            @foreach(DB::table('slider')->get() as $u)
                                <tr>
                                    ...
                                    <td>
                                        <a href="?slider={{$u->id}}&sil&token={{ csrf_token() }}" class="btn btn-outline-danger btn-min-width">
                                            <i class="la la-trash"></i>
                                            <span>
                                                Sil
                                            </span>
                                        </a>
                                        <a href="/slider-duzenle/{{$u->id}}" class="btn btn-outline-info btn-min-width">
