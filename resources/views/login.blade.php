                                ...
                                <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <div class="card-body pt-1">
                                            <form action="index.html">
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input name="email" type="text" class="form-control" id="user-name" placeholder="E-posta" required>
                                                ...
                                                <fieldset class="form-label-group position-relative has-icon-left">
                                                    <input name="password" type="password" class="form-control" id="user-password" placeholder="Şifre" required>
                                                    <div class="form-control-position">
                                                ...
                                                <a href="auth-register.html" class="btn btn-outline-primary float-left btn-inline">Kayıt Ol</a>
                                    ...
                                    <div class="login-footer">
                                        ...
                                        <div class="footer-btn d-inline">
                                            ...
                                            <a href="#" class="btn btn-github"><span class="fa fa-github"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
