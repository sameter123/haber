                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="label-control" for="userinput1">Başlık</label>
                                        <input
                                            type="text"
                                            id="userinput1"
                                            class="form-control border-success"
                                            placeholder="Başlık"
                                            value="{{$hakkimizda->title}}"
                                            name="title"
                                            required
                                        >
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label class="label-control" for="userinput2">Hakkımızda Alt Başlık</label>
                                        <input
                                            type="text"
                                            id="userinput2"
                                            class="form-control border-success"
                                            placeholder="Alt başlık"
                                            value="{{$hakkimizda->title_2}}"
                                            name="title_2">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="label-control" for="userinput3">Hakkımızda Metni</label>
                                        <textarea class="summernote form-control border-success" name="text" id="userinput3">{{$hakkimizda->text}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <img class="img form-control" src="{{asset('/public/img/'.$hakkimizda->image)}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="label-control text-danger" for="userinput4">Hakkımızda kısmının kapak görselini değiştirmek için yeni resim seçin ve yükleyin</label>
                                                <input
                                                    id="userinput4"
                                                    type="file"
                                                    name="image"
